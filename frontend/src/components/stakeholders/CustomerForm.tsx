...
import type { CreateCustomerData, Customer, UpdateCustomerData } from "@/types/stakeholders/customer.types"
...
const CustomerForm: React.FC<CustomerFormProps> = ({ initialData, onSubmit, onCancel, isSubmitting = false }) => {
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <div className="modal-info-alert">
        ...
        <div>
          ...
          <p className="mb-0">Asegúrate de ingresar datos reales y válidos del cliente. La información ingresada será utilizada en informes y procesos contables, por lo que debe ser precisa.</p>
        </div>
      </div>
