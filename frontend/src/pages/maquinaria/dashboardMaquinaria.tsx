          ...
          >
            ...
            <div className="card-body" style={{ padding: "1.5rem" }}>
              ...
              <Row className="g-4">
                  ...
                  <Col md={3}>
                    ...
                    >
                      <Card.Body className="p-4 text-center">
                        ...
                        >
                          <i className="bi bi-graph-up text-white" style={{ fontSize: "2.5rem" }}></i>
                        </div>
                        <Card.Title className="fw-bold text-dark mb-2 fs-5">Reportes de Eficiencia</Card.Title>
                        <Card.Text className="text-muted small mb-3">
                          Análisis de rendimiento y costos operativos
                        </Card.Text>
                        <div className="d-flex align-items-center justify-content-center">
                ...
                {/* Tarjeta de Mi Perfil Técnico - Visible para todos excepto SuperAdministrador */}
                  ...
                  <Col md={3}>
                    ...
                    >
                      <Card.Body className="p-4 text-center">
                        ...
                        <Card.Title className="fw-bold text-dark mb-2 fs-5">Mi Perfil Técnico</Card.Title>
                        <Card.Text className="text-muted small mb-3">
                          Consulta tu información y especialidades
                        </Card.Text>
                        <div className="d-flex align-items-center justify-content-center">
                          <small className="text-primary fw-semibold">
                            <i className="bi bi-arrow-right me-1"></i>
                  ...
                  <Col md={3}>
                    ...
                    >
                      <Card.Body className="p-4 text-center">
                        ...
                        >
                          <i className="bi bi-list-task text-white" style={{ fontSize: "2.5rem" }}></i>
                        </div>
                        <Card.Title className="fw-bold text-dark mb-2 fs-5">Mis Asignaciones</Card.Title>
                        <Card.Text className="text-muted small mb-3">Tareas y equipos asignados a tu cargo</Card.Text>
                        <div className="d-flex align-items-center justify-content-center">
                          <small className="text-muted">
                            <i className="bi bi-clock me-1"></i>
                            Próximamente
                  ...
                  <Col md={3}>
                    ...
                    >
                      <Card.Body className="p-4 text-center">
                        ...
                        <Card.Text className="text-muted small mb-3">
                          Visualiza tu cuenta y cambia tu contraseña
                        </Card.Text>
                        <div className="d-flex align-items-center justify-content-center">
                          <small className="text-primary fw-semibold">
                            <i className="bi bi-arrow-right me-1"></i>
