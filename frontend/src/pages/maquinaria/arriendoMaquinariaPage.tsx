          ...
          <div className="d-flex align-items-center justify-content-between mb-4">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="text-muted mb-0">Registra y gestiona los reportes de trabajo diario de maquinaria</p>
              </div>
            </div>
            <div>
              <Button variant="success" onClick={() => navigate("/maquinaria/compras")}>
