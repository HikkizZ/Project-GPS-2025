...
router.put("/:id", authenticateJWT, verifyRole(["Arriendo", "Mecánico", "Mantenciones de Maquinaria"]), FileUploadService.uploadSingle("padron"), idValidation, updateMaquinariaValidation, maquinariaController.update)
...
router.patch("/:id/padron", authenticateJWT, verifyRole(["Arriendo", "Mecánico", "Mantenciones de Maquinaria"]), FileUploadService.uploadSingle("padron"), idValidation, maquinariaController.actualizarPadron)
...
router.get("/:id/padron", authenticateJWT, verifyRole(["SuperAdministrador", "Arriendo", "Mecánico", "Mantenciones de Maquinaria"]), idValidation, maquinariaController.descargarPadron)
